...
inline ::Command::ServiceType Register::type() const {
  // @@protoc_insertion_point(field_get:Login.Register.type)
...
inline void Register::set_type(::Command::ServiceType value) {
  ...
  set_has_type();
  type_ = value;
  // @@protoc_insertion_point(field_set:Login.Register.type)
}
...
inline ::Command::ChannelID Register::channel() const {
  // @@protoc_insertion_point(field_get:Login.Register.channel)
...
inline void Register::set_channel(::Command::ChannelID value) {
  ...
  set_has_channel();
  channel_ = value;
  // @@protoc_insertion_point(field_set:Login.Register.channel)
}
...
inline ::Command::ErrorCode RegisterResponse::errorcode() const {
  // @@protoc_insertion_point(field_get:Login.RegisterResponse.errorCode)
...
inline void RegisterResponse::set_errorcode(::Command::ErrorCode value) {
  ...
  set_has_errorcode();
  errorcode_ = value;
  // @@protoc_insertion_point(field_set:Login.RegisterResponse.errorCode)
}

...
inline ::RPC::ServerID RpcHeader::server() const {
  // @@protoc_insertion_point(field_get:RPC.RpcHeader.server)
...
inline void RpcHeader::set_server(::RPC::ServerID value) {
  ...
  set_has_server();
  server_ = value;
  // @@protoc_insertion_point(field_set:RPC.RpcHeader.server)
}
...
inline ::RPC::MethodID RpcHeader::method() const {
  // @@protoc_insertion_point(field_get:RPC.RpcHeader.method)
...
inline void RpcHeader::set_method(::RPC::MethodID value) {
  ...
  set_has_method();
  method_ = value;
  // @@protoc_insertion_point(field_set:RPC.RpcHeader.method)
}
...
template <> struct is_proto_enum< ::RPC::ServerID> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::RPC::ServerID>() {
  return ::RPC::ServerID_descriptor();
}
template <> struct is_proto_enum< ::RPC::MethodID> : ::google::protobuf::internal::true_type {};
template <>
